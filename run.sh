...
# running
if java -Xmx1000m -classpath dist/code_swarm.jar:lib/core.jar:lib/xml.jar:lib/vecmath.jar:lib/opengl.jar:lib/jogl.jar:lib/gluegen-rt.jar:. code_swarm $params; then
